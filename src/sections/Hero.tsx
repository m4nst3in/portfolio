    ...
    <div className="text-center">
      ...
      <h1 className="scroll-m-20 text-3xl font-extrabold tracking-tight md:text-7xl text-white mt-1 md:mx-20">
        ...
        <div className="text-center w-full mt-7 md:mt-10 ">
          <Button onClick={() => window.location.href = '/public/developer.pdf' } className="px-5 bg-gradient-to-r from-white to-sky-200 text-gray-900 font-medium text-md rounded-full mx-3 font-mono hover:bg-white hover:opacity-90 md:scale-150 md:mx-14">
