...
const Navbar: React.FC = () => {
  return (
    <nav className="sticky top-0 w-full h-14 md:h-20 bg-gray-950 flex flex-row items-center justify-between z-20 backdrop-filter backdrop-blur-md bg-opacity-30">
      <div className="flex flex-row items-center mx-4">
        <a href="m4nst3in.github.io" className="text-2xl md:text-3xl font-semibold tracking-tight text-white flex flex-row">
          <p className="text-green-400">M4nsT3in<span className="text-white">.dev</span></p>
        </a>
      </div>
